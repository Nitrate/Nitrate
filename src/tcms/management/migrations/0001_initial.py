    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(max_length=5, serialize=False, primary_key=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "milestone_url",
                    models.CharField(default="---", max_length=128, db_column="milestoneurl"),
                ),
                (
                    "disallow_new",
                    models.BooleanField(default=False, db_column="disallownew"),
                ),
                (
                    "vote_super_user",
                    models.IntegerField(default=True, null=True, db_column="votesperuser"),
                ),
                (
                    "max_vote_super_bug",
                    models.IntegerField(default=10000, db_column="maxvotesperbug"),
                ),
                (
                    "votes_to_confirm",
                    models.BooleanField(default=False, db_column="votestoconfirm"),
                ),
                (
                    "default_milestone",
                    models.CharField(default="---", max_length=20, db_column="defaultmilestone"),
                ),
                (
                    "classification",
                    models.ForeignKey(to="management.Classification", on_delete=models.CASCADE),
                ),
            ],
            options={
                "db_table": "products",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group",
                    models.ForeignKey(to="management.TCMSEnvGroup", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "attachment_id",
                    models.AutoField(max_length=10, serialize=False, primary_key=True),
                ),
                (
                    "description",
                ...
                (
                    "file_name",
                    models.CharField(unique=True, max_length=255, db_column="filename", blank=True),
                ),
                (
                    "stored_name",
                    models.CharField(max_length=128, unique=True, null=True, blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attachment",
                    models.ForeignKey(to="management.TestAttachment", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "build_id",
                    models.AutoField(max_length=10, unique=True, serialize=False, primary_key=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(
                        related_name="environment_categories",
                        to="management.Product",
                        on_delete=models.CASCADE,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_private",
                    models.BooleanField(default=False, db_column="isprivate"),
                ),
                (
                    "env_category",
                    models.ForeignKey(
                        to="management.TestEnvironmentCategory",
                        on_delete=models.CASCADE,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "element",
                    models.ForeignKey(
                        to="management.TestEnvironmentElement", on_delete=models.CASCADE
                    ),
                ),
                (
                    "environment",
                    models.ForeignKey(to="management.TestEnvironment", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="management.TestEnvironmentProperty", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(

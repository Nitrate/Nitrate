    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "plan_id",
                    models.AutoField(max_length=11, serialize=False, primary_key=True),
                ),
                ...
                (
                    "is_active",
                    models.BooleanField(default=True, db_index=True, db_column="isactive"),
                ),
                (
                    "extra_link",
                    models.CharField(default=None, max_length=1024, null=True, blank=True),
                ),
            ],
            options={
                "db_table": "test_plans",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "plan",
                    models.ForeignKey(to="testplans.TestPlan", on_delete=models.CASCADE),
                ),
                (
                    "who",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "component",
                    models.ForeignKey(to="management.Component", on_delete=models.CASCADE),
                ),
                (
                    "plan",
                    models.ForeignKey(to="testplans.TestPlan", on_delete=models.CASCADE),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "userid",
                    models.IntegerField(unique=True, serialize=False, primary_key=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tag",
                    models.ForeignKey(to="management.TestTag", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(serialize=False, primary_key=True, db_column="type_id"),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="management.TestAttachment", through="testplans.TestPlanAttachment"
            ),
        ),
        migrations.AddField(
            model_name="testplan",
        ...
        migrations.AddField(
            ...
            name="component",
            field=models.ManyToManyField(
                to="management.Component", through="testplans.TestPlanComponent"
            ),
        ),
        migrations.AddField(
            model_name="testplan",
            name="env_group",
            field=models.ManyToManyField(
                to="management.TCMSEnvGroup", through="testplans.TCMSEnvPlanMap"
            ),
        ),
        migrations.AddField(
            model_name="testplan",
        ...
        migrations.AddField(
            ...
            name="product",
            field=models.ForeignKey(
                related_name="plan", to="management.Product", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="testplan",
            ...
            field=models.ForeignKey(
                related_name="plans", to="management.Version", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="testplan",

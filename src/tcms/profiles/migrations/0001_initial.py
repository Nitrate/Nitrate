    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group",
                    models.ForeignKey(to="profiles.Groups", on_delete=models.CASCADE),
                ),
                (
                    "user",
                    models.ForeignKey(to="profiles.Profiles", on_delete=models.CASCADE),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="content_type",
            field=models.ForeignKey(
                related_name="content_type_set_for_bookmark",

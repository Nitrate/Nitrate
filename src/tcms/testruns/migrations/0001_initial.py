    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "build",
                    models.ForeignKey(to="management.TestBuild", on_delete=models.CASCADE),
                ),
                (
                    "case",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estimated_time",
                    tcms.core.models.fields.DurationField(default=0, max_length=11),
                ),
                ("environment_id", models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "run",
                    models.ForeignKey(to="testruns.TestRun", on_delete=models.CASCADE),
                ),
                (
                    "tag",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                to="management.TCMSEnvValue", through="testruns.TCMSEnvRunValueMap"
            ),
        ),
        migrations.AddField(
            model_name="testrun",
        ...
        migrations.AddField(
            ...
            name="plan",
            field=models.ForeignKey(
                related_name="run", to="testplans.TestPlan", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="testrun",
        ...
        migrations.AddField(
            ...
            name="run",
            field=models.ForeignKey(
                related_name="case_run", to="testruns.TestRun", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="testcaserun",

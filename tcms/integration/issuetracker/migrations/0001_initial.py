...
import tcms.integration.issuetracker.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validate_regex', models.CharField(help_text='Regular expression in Python Regular Expression syntax, which is used to validate issue ID. This regex will be used in both JavaScript code and Python code. So, please write it carefully.', max_length=100, validators=[tcms.integration.issuetracker.validators.validate_reg_exp])),
                ...
                ('class_path', models.CharField(default='tcms.integration.issuetracker.models.IssueTrackerService', help_text='Importable path to the implementation for this issue tracker. Default is <code>tcms.integration.issuetracker.models.IssueTrackerService</code>, which provides basic functionalities for general purpose. Set to a custom path for specific class inherited from <code>IssueTrackerService</code>', max_length=100, validators=[tcms.integration.issuetracker.validators.validate_class_path])),

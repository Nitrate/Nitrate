...
from tcms.integration.issuetracker.task import bugzilla_external_track
from tcms.integration.issuetracker.models import Issue
from tcms.integration.issuetracker.models import ProductIssueTrackerRelationship
...
class IssueTrackerService(object):
    ...
    def add_external_tracker(self, issue):
        ...
        :type issue: :class:`Issue <tcms.integration.issuetracker.models.Issue>`
        """
